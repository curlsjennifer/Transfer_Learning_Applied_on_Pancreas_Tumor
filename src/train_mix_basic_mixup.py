...
# Model Init
    ...
    if mode == 'trans_2':
        ...
        model.load_weights(os.path.join(model_path, exp_name + '.h5'), by_name=True)
    ...
    training_generator = MixupGenerator(train_X, train_y, batch_size=config['train']['batch_size'], alpha=0.2)()
